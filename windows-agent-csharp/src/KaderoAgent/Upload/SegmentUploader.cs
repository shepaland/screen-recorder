...
public class SegmentUploader
{
        ...
        string serverUrl, CancellationToken ct = default)
    {
        ...
        {
            // 404 = session not found on server (expired/closed).
            // Invalidate session so UploadQueue creates a new one, save segment for retry.
            ...
            return false; // Don't discard - save to pending for retry with new session
        }
