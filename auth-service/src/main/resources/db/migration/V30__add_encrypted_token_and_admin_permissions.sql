...
VALUES
  (gen_random_uuid(), 'DEVICE_TOKENS:REVEAL', 'Reveal Device Token', 'DEVICE_TOKENS', 'REVEAL', 'Reveal raw device registration token'),
  (gen_random_uuid(), 'DEVICE_TOKENS:HARD_DELETE', 'Hard Delete Device Token', 'DEVICE_TOKENS', 'HARD_DELETE', 'Permanently delete device registration token'),
  (gen_random_uuid(), 'USERS:HARD_DELETE', 'Hard Delete User', 'USERS', 'HARD_DELETE', 'Permanently delete user')
